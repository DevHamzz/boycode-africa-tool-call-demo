...
// Each theme supplies the CSS variables consumed by the shared stylesheet and components.
...
function applyTheme(t: Theme) {
  // CSS variables let the whole UI switch themes without rerendering every visual element.
...
export function ThemeProvider({ children }: { children: ReactNode }) {
  // Restore the user's last choice before rendering and persist future changes locally.
